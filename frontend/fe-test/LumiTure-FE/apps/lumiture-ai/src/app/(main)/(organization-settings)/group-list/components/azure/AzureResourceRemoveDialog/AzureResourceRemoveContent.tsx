...
import {
  useCheckAzureResource,
  useDeleteAzureResources,
  type AzureAssignedResourcesInfos,
} from '@hooks-api';
...
export function AzureResourceRemoveContent({
  ...
  const { mutateAsync: checkResources, isPending: isCheckPending } = useCheckAzureResource();
